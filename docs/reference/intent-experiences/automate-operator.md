---
title: "Intent experience: automate for operator"
...
# Intent experience: automate for operator

This page is assembled for the `automate` intent and the `operator` audience using reusable modules.

```bash
python3 scripts/assemble_intent_experience.py \
  --intent automate --audience operator --channel docs
```
