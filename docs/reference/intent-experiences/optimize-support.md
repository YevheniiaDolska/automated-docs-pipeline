---
title: 'Intent experience: optimize for support'
...
This page is assembled for the `optimize` intent and the `support` audience using reusable modules.

```bash
python3 scripts/assemble_intent_experience.py \
  --intent optimize --audience support --channel docs
```
