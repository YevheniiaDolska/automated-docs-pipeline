(function () {
  ...
  var runtimeLocale = script.dataset.locale || (navigator.language || "en");
  ...
  function sendFeedback(helpful) {
    ...
    fetch(feedbackEndpoint, {
      ...
      headers: {
        ...
        "X-User-Plan": plan,
        "X-Ask-AI-Locale": runtimeLocale,
        "Accept-Language": runtimeLocale
      },
      body: JSON.stringify({
  ...
  button.addEventListener("click", function () {
    ...
    fetch(endpoint, {
      ...
      body: JSON.stringify({ question: question, locale: runtimeLocale })
    })
      .then(function (res) {
        return res.json().then(function (data) {
          if (!res.ok) {
