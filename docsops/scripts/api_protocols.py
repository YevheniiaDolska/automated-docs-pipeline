...
def _clean_protocol(value: str) -> str:
    """Internal helper for `_clean_protocol`."""
...
def default_asyncapi_ws_endpoint() -> str:
    """Execute `default_asyncapi_ws_endpoint` workflow."""
    return ECHO_WS_PRIMARY


def default_websocket_endpoint() -> str:
    """Execute `default_websocket_endpoint` workflow."""
    return ECHO_WS_PRIMARY


def default_graphql_endpoint() -> str:
    """Execute `default_graphql_endpoint` workflow."""
    return ECHO_HTTP_POST


def default_grpc_gateway_endpoint() -> str:
    """Execute `default_grpc_gateway_endpoint` workflow."""
    return ECHO_HTTP_POST


def default_asyncapi_http_publish_endpoint() -> str:
    """Execute `default_asyncapi_http_publish_endpoint` workflow."""
    return ECHO_HTTP_POST


def default_websocket_http_bridge_endpoint() -> str:
    """Execute `default_websocket_http_bridge_endpoint` workflow."""
    return ECHO_HTTP_POST
