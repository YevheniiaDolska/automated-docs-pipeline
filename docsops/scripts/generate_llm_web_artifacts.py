...
def _parse_frontmatter(text: str) -> tuple[dict[str, Any], str]:
    """Internal helper for `_parse_frontmatter`."""
...
def _extract_title(meta: dict[str, Any], body: str, fallback: str) -> str:
    """Internal helper for `_extract_title`."""
...
def _extract_summary(meta: dict[str, Any], body: str) -> str:
    """Internal helper for `_extract_summary`."""
...
def _write_text(path: Path, content: str) -> None:
    """Internal helper for `_write_text`."""
