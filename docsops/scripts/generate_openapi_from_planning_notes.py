...
def pointer_escape(value: str) -> str:
    """Execute `pointer_escape` workflow."""
    return value.replace("~", "~0").replace("/", "~1")


def op_id(method: str, path: str) -> str:
    """Execute `op_id` workflow."""
...
def group_for_path(path: str) -> str:
    """Execute `group_for_path` workflow."""
...
def make_operation(method: str, path: str, desc: str) -> dict[str, Any]:
    """Execute `make_operation` workflow."""
...
def schemas_common() -> dict[str, Any]:
    """Execute `schemas_common` workflow."""
    return {
        "BaseResource": {
            "type": "object",
...
def parameters_common() -> dict[str, Any]:
    """Execute `parameters_common` workflow."""
    return {
        "RequestId": {
            "name": "X-Request-Id",
            "in": "header",
...
def responses_common() -> dict[str, Any]:
    """Execute `responses_common` workflow."""
    return {
        "Error400": {
