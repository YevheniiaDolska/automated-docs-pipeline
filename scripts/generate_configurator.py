...
<title>VeriOps Configurator</title>
<style>
/* ------------------------------------------------------------------ */
/* Reset & base                                                        */
/* ------------------------------------------------------------------ */
...
function generateVariablesYaml() {{
  ...
  return `# VeriOps - Product Variables
# Generated by VeriOps Configurator
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate the VeriOps GUI configurator"
    )
    parser.add_argument(
        "--output",
